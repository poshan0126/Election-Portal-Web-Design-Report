...
\textsc{\LARGE Nepal College of Information and Technology}\\[1.5cm] % Name of your university/college
\textsc{\Large Web-Design Competition}\\[0.5cm] % Major heading such as course name
...
\HRule \\[0.4cm]
{ \huge \bfseries Election Portal}\\[0.4cm] % Title of your document
...
\includegraphics[scale=0.4]{logo.png}\\[1cm] % Include a department/university logo - this will require the graphicx package
